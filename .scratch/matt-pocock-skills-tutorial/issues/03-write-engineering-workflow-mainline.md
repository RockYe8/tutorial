# 03 - 写工程化篇主链路：从 Setup 到 Code Review

**What to build:** Write the main engineering workflow article sections that take an existing Todo app from repository setup through clarified design, spec, tickets, implementation, TDD, and code review.
